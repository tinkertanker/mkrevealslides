...
use clap::{command, value_parser, Arg, ArgAction, ArgGroup};
...
fn main() -> Result<(), AppError> {
    let matches = command!()
        ...
        .arg(
            Arg::new("template_file")
                .help(
                    "The template file to generate the slides from. \
        ...
        .arg(
            Arg::new("verbose")
                ...
                .long_help(
                    "Displays tracing (logging) information to the console. \
    ...
    debug!(
        ...
        slide_config.output_file.display()
    );
